#' make_lines()
#'
#' Converts GPS data/ waypoints to line features.  Attribute data is maintained. This script uses the point to transect.
#' _The tracklog is not used_.
#'
#' @param GPSPoints is a _simple features_ POINT object.  Minimum attributes in this file include fields named _'id'_ and _'time'_.  Waypoints will be sorted by these two entries.
#' @param Transects is the original planned transect simple feature.  The _'id'_ attribute in this feature will be used to group points by their transect id. This transect id will be named 'TID' in the output data.
...
make_lines <- function(GPSPoints, Transects, tBuffer = 20, PROJ = 3005) {
