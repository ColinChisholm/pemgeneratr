#' Intended for creating the sampling plan -- numerous entries have been commented out.
...
create_covariates_plan <- function(dtm, SAGApath = "",
                              output = "./cv-rasters",
                              layers = "all"){
...
sDTM <- "Filled_sinks.sdat" ## subsequent models use filled sinks
